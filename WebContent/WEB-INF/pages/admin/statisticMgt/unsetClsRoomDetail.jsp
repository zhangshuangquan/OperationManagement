	...
	<c:if test="${classroomType eq 'MASTER' && classType ne 'Y'}">
		<h3 class="cataMenu navMenu mb10">
			<span class="tabMenu">
				...
				<a class="tabItem selected" href="javascript:switchTab(1)">未创建课表的主讲教室</a>
...
<script type="text/javascript">
	...
	function search(){
		var url  = "${root}/admin/statisticsAnaly/getUnsetClsroomDetail.do";	
		var param  = {
	...
	function exportData(){
		$("#tempDataForm").attr("action","exportUnsetClsroomDetail.html");
		$("#tempDataForm").submit();
	}
	 ...
	 $(document).ready(function(){
		 ...
		 $("#query").click(search);	 
		   ...
		   mySplit = new SplitPage({
			    node : $id("pageNavi"),
			    url : "${root}/admin/statisticsAnaly/getUnsetClsroomDetail.do",
			    data:{
			    	classroomType:classroomType,
			    	classType:classType,
					startDt:startDt,
...
<form id="tempDataForm" action="exportUnsetClsroomDetail.html" method="post">
