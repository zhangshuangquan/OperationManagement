...
<script>
	...
	function submitForm() {
		...
		$.ajaxFileUpload({
	    	url					:	'${root}/admin/classroom/batchAddClassroom.do' , 	// === 需要链接到服务器地址
	    	type: 'post',
	    	secureuri			:	false ,
	     	fileElementId	:	'classroomInput' ,                  			 			// === 文件选择框的id属性
...
<div class="commonWrap" style="padding:10px;">
	<div id="downloadModel" class="addNewBox" >
		<a id="addOrgUserBatch" class="btn btnGreen" href="${root }/admin/commons/downloadUserModel.do?userType=classroom">模板下载</a>
	</div>
	<div id="uploadExcel">
		<ul class="commonUL">
			...
			<li><label class="text">Excel导入：</label>
				<span class="cont">
					<input type="file" id="classroomInput" name="classroomInput" />
				</span>
			</li>
			<li class="center">
