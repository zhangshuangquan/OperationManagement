...
<body>
	<div class="commonWrap" style="padding:10px;">
		<div id="downloadModel" class="addNewBox" >
			<a id="addOrgUserBatch" class="btn btnGreen" href="${root }/admin/commons/downloadUserModel.do?userType=schoolManager">模板下载</a>
		</div>
		<div id="uploadExcel">
			<ul class="commonUL">
				...
				<li><label class="text">Excel导入：</label>
					<span class="cont">
							<input type="file" size="30"  name="clsSchoolFile" id="clsSchoolFile"/>
					</span>
				</li>
				<li class="center">
	...
	<script>
		function ajaxFileUpload() {
			$.ajaxFileUpload({
	            url: '${root}/admin/schoolmgt/batchAddSchool.do', 
	            type: 'post',
	            secureuri: false, //一般设置为false
	            fileElementId: 'clsSchoolFile', // 上传文件的id、name属性名
		...
		function submitForm() {
			...
			var fileName = $("#clsSchoolFile").val();
			if(fileName == '') {
				Win.alert("请选择文件");
				return;
