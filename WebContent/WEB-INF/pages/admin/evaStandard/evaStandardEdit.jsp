...
<%@ include file="evaStandardCommon.jsp" %>
    ...
    $(document).ready(function(){
    	...
    	if(standardName != null && standardName != ''){
	    	...
	    	$.ajax({
	    		 ...
	    		 type: 'GET',
	    		 async:false,
	    		 data: {standardName:standardName , standardId:standardId},
    ...
    window.addEvaluationCheck = new BasicCheck({
		...
		ajaxReq : function(){
			$.post('${root}/admin/evaStandard/edit/confirm.do', $("#editEvaluation").serializeArray(), function(data){
				if(data.result){
...
<body>
<h3 id="cataMenu">
	<a href="javascript:;">评课管理</a> &gt; <a href="javascript:;">系统默认评估标准</a> &gt; <a href="javascript:;">编辑</a>
</h3>
<div id="control">
	<div id="controlContent">
	<form id="editEvaluation" action="">
